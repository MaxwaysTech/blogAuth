...
class BlogPost(db.Model):
    ...
    children_post = relationship("Comment", back_populates="parent_post")
...
class Comment(db.Model):
    ...
    parent_post = relationship("BlogPost", back_populates="children_post")
...
def register():
    ...
    if form.validate_on_submit():
        ...
        if user:
            flash(message="Email already exist, Login instead")
...
def login():
    ...
    if form.validate_on_submit():
        ...
        if not user:
            ...
            flash(message="password does not exist")
            return redirect(url_for("login"))
        else:
            login_user(user)
            return redirect(url_for("get_all_posts"))
